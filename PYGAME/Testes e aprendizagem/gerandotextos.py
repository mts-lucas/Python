...
while True:
    relogio.tick(30)
    tela.fill((0, 0, 0))
    mensagem = "Pontos: {}".format(pontos) # mensagem pra exibir pontos e contar
    texto_formatado = fonte.render(mensagem, True, (255, 255, 255)) #variavel a ser exibida com a fonte, anti-serrilhamento?, cor 
    ...
    if ret_red.colliderect(ret_blue):  
        ...
        yblue = randint(50, 430)
        pontos = pontos + 1
    tela.blit(texto_formatado, (420,40)) #onde vai ser exbida a msg: qual msg, posição na tela
